...
for resultado in resultados:
    ...
    print(f"  Média Harmônica: {resultado['media_harmonica']}")
...
print("APLICAÇÃO DO MACHINE LEARNING UTILIZANDO REDES NEURAIS")   
print("------------------------------------------------------------------------") 
print("------------------------------------------------------------------------\n") 
...
print("Número previsto de nascidos vivos no mês 13:", previsto[0])    
...
previsto = regressor.predict([[13]])
print("Número previsto de nascidos masculinos no mês 13:", previsto[0])
...
previsto = regressor.predict([[13]])
print("Número previsto de nascidos femininos no mês 13:", previsto[0])
...
previsto = regressor.predict([[13]])
print("Número previsto de nascidos de parto cesario no mês 13:", previsto[0])
...
previsto = regressor.predict([[13]])
print("Número previsto de nascidos de parto vaginal no mês 13:", previsto[0])
...
regressor.fit(meses_numeros_vaginal, X)
previsto = regressor.predict([[13]])
print("Número previsto de nascidos gemeos no mês 13:", previsto[0])
...
for mes in meses:
    ...
    print(f"Recém nascidos com baixo peso em {mes}: {valor}")
...
previsto = regressor.predict([[13]])
print("Número previsto de recém nascidos com baixo peso no mês 13:", previsto[0])
...
previsto = regressor.predict([[13]])
print("Número previsto de recem nascidos com peso ideal no mês 13:", previsto[0])
